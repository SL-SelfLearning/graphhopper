...
public class PathExtract {
    ...
    PathExtract(Path path, EncodingManager encodingManager) {
        ...
        // TODO NOW access car.average_speed or motor_vehicle.max_speed instead?
        maxSpeedEnc = encodingManager.getEncodedValue("max_speed", DecimalEncodedValue.class);
        roundaboutEnc = encodingManager.getEncodedValue("roundabout", BooleanEncodedValue.class);
    }
