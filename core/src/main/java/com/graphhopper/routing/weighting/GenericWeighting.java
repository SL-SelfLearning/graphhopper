...
public class GenericWeighting extends AbstractWeighting {
    ...
    public GenericWeighting(DataFlagEncoder encoder, PMap hintsMap) {
        ...
        maxHeightEnc = gEncoder.getDecimalEncodedValue("max_height");
        weight = hintsMap.getDouble(WEIGHT_LIMIT, 0d);
        maxWeightEnc = gEncoder.getDecimalEncodedValue("max_weight");
        width = hintsMap.getDouble(WIDTH_LIMIT, 0d);
        maxWidthEnc = gEncoder.getDecimalEncodedValue("max_width");
        ...
        maxSpeedEnc = gEncoder.getDecimalEncodedValue(gEncoder.getPrefix() + "max_speed");
