...
public class BridgeElevationInterpolatorTest extends AbstractEdgeElevationInterpolatorTest {
    ...
    public void interpolatesElevationOfPillarNodes() {
        ...
        // TODO name clash if DFEncoder is used at the same time as CarFlagEncoder?
        BooleanEncodedValue dfeAccessEnc = dataFlagEncoder.getBooleanEncodedValue("car.access");

        EdgeIteratorState edge01 = GHUtility.createEdge(graph, dfeAccessEnc, 0, 1, 10, true);
        EdgeIteratorState edge12 = GHUtility.createEdge(graph, dfeAccessEnc, 1, 2, 10, true);
        EdgeIteratorState edge23 = GHUtility.createEdge(graph, dfeAccessEnc, 2, 3, 10, true);
        EdgeIteratorState edge34 = GHUtility.createEdge(graph, dfeAccessEnc, 3, 4, 10, true);
        EdgeIteratorState edge56 = GHUtility.createEdge(graph, dfeAccessEnc, 5, 6, 10, true);
        EdgeIteratorState edge67 = GHUtility.createEdge(graph, dfeAccessEnc, 6, 7, 10, true);
        EdgeIteratorState edge78 = GHUtility.createEdge(graph, dfeAccessEnc, 7, 8, 10, true);
        EdgeIteratorState edge89 = GHUtility.createEdge(graph, dfeAccessEnc, 8, 9, 10, true);
        EdgeIteratorState edge17 = GHUtility.createEdge(graph, dfeAccessEnc, 1, 7, 10, true);
        EdgeIteratorState edge27 = GHUtility.createEdge(graph, dfeAccessEnc, 2, 7, 10, true);
        EdgeIteratorState edge37 = GHUtility.createEdge(graph, dfeAccessEnc, 3, 7, 10, true);
