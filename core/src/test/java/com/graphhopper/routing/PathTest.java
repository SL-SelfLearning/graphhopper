...
public class PathTest {
    ...
    private final EncodingManager carManager = new EncodingManager.Builder().addGlobalEncodedValues().addAll(encoder).build();
    private final BooleanEncodedValue carAccessEnc = carManager.getBooleanEncodedValue(TagParserFactory.Car.ACCESS);

    private final EncodingManager dataFlagManager = new EncodingManager.Builder().addGlobalEncodedValues().addAll(dataFlagEncoder).build();
    private final FlagEncoder carEncoderMixed = new CarFlagEncoder();
    private final EncodingManager mixedEncoders = new EncodingManager.Builder().addAll(
    ...
    public void testWayList() {
        ...
        EdgeIteratorState edge1 = GHUtility.createEdge(g, carAccessEnc, 0, 1, 1000d, true);
        edge1.set(averageSpeedEnc, 10d);
        edge1.setWayGeometry(Helper.createPointList(8, 1, 9, 1));
        EdgeIteratorState edge2 = GHUtility.createEdge(g, carAccessEnc, 2, 1, 2000d, true);
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 3, 1000d, true).set(averageSpeedEnc, 10d);
    ...
    public void testFindInstruction() {
        ...
        EdgeIteratorState edge2 = GHUtility.createEdge(g, carAccessEnc, 1, 2, 1000d, true);
        edge2.set(averageSpeedEnc, 50d);
        edge2.setWayGeometry(Helper.createPointList());
        edge2.setName("Street 2");
        EdgeIteratorState edge3 = GHUtility.createEdge(g, carAccessEnc, 2, 3, 1000d, true);
        edge3.set(averageSpeedEnc, 50d);
        edge3.setWayGeometry(Helper.createPointList());
        edge3.setName("Street 3");
        EdgeIteratorState edge4 = GHUtility.createEdge(g, carAccessEnc, 3, 4, 500d, true);
        edge4.set(averageSpeedEnc, 50d);
        edge4.setWayGeometry(Helper.createPointList());
        edge4.setName("Street 4");

        GHUtility.createEdge(g, carAccessEnc, 1, 5, 10000d, true).set(averageSpeedEnc, 50d);
        GHUtility.createEdge(g, carAccessEnc, 2, 5, 10000d, true).set(averageSpeedEnc, 50d);
        GHUtility.createEdge(g, carAccessEnc, 3, 5, 100000d, true).set(averageSpeedEnc, 50d);
    ...
    public void testCalcInstructionsRoundaboutIssue353() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 2, 1, 5, false).setName("MainStreet 2 1");
        GHUtility.createEdge(g, carAccessEnc, 1, 11, 5, false).setName("MainStreet 1 11");

        // roundabout
        EdgeIteratorState tmpEdge;
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 3, 9, 2, false).setName("3-9");
        tmpEdge.set(roundaboutEnc, true);
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 9, 10, 2, false).setName("9-10");
        tmpEdge.set(roundaboutEnc, true);
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 6, 10, 2, false).setName("6-10");
        tmpEdge.set(carAccessEnc, true);
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 10, 1, 2, false).setName("10-1");
        tmpEdge.set(carAccessEnc, true);
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 3, 2, 5, false).setName("2-3");
        tmpEdge.set(carAccessEnc, true);
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 4, 3, 5, false).setName("3-4");
        tmpEdge.set(carAccessEnc, true);
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 5, 4, 5, false).setName("4-5");
        tmpEdge.set(carAccessEnc, true);
        tmpEdge = GHUtility.createEdge(g, carAccessEnc, 2, 5, 5, false).setName("5-2");
        tmpEdge.set(carAccessEnc, true);

        GHUtility.createEdge(g, carAccessEnc, 4, 7, 5, true).setName("MainStreet 4 7");
        GHUtility.createEdge(g, carAccessEnc, 5, 8, 5, true).setName("5-8");
        GHUtility.createEdge(g, carAccessEnc, 3, 6, 5, true).setName("3-6");
    ...
    public void testCalcInstructionForForkWithSameName() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 2, 5, true).setName("Regener Weg");
        GHUtility.createEdge(g, carAccessEnc, 2, 4, 5, true).setName("Regener Weg");
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 5, true);
    ...
    public void testCalcInstructionContinueLeavingStreet() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 2, 5, true).setName("Regener Weg");
        GHUtility.createEdge(g, carAccessEnc, 2, 4, 5, true);
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 5, true).setName("Regener Weg");
    ...
    public void testCalcInstructionSlightTurn() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 2, 5, true).setName("Stöhrgasse");
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 5, true);
        GHUtility.createEdge(g, carAccessEnc, 2, 4, 5, true).setName("Stöhrgasse");
    ...
    public void testCalcInstructionsForDataFlagEncoder() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 2, 5, true).
    ...
    public void testCalcInstructionsForSlightTurnOntoDifferentStreet() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 3, 5, true).setName("Talstraße, K 4313");
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 5, true).setName("Calmbacher Straße, K 4312");
        GHUtility.createEdge(g, carAccessEnc, 3, 4, 5, true).setName("Calmbacher Straße, K 4312");
    ...
    private class RoundaboutGraph {
        ...
        private RoundaboutGraph() {
            ...
            GHUtility.createEdge(g, mixedCarAccessEnc, 1, 2, 5, true).setName("MainStreet 1 2");

            // roundabout
            roundaboutEdges.add(GHUtility.createEdge(g, mixedCarAccessEnc, 3, 2, 5, false).setName("2-3"));
            roundaboutEdges.add(GHUtility.createEdge(g, mixedCarAccessEnc, 4, 3, 5, false).setName("3-4"));
            roundaboutEdges.add(GHUtility.createEdge(g, mixedCarAccessEnc, 5, 4, 5, false).setName("4-5"));
            roundaboutEdges.add(GHUtility.createEdge(g, mixedCarAccessEnc, 2, 5, 5, false).setName("5-2"));

            GHUtility.createEdge(g, mixedCarAccessEnc, 4, 7, 5, true).setName("MainStreet 4 7");
            GHUtility.createEdge(g, mixedCarAccessEnc, 5, 8, 5, true).setName("5-8");

            edge3to6 = GHUtility.createEdge(g, mixedCarAccessEnc, 3, 6, 5, true).setName("3-6");
            edge3to9 = GHUtility.createEdge(g, mixedCarAccessEnc, 3, 9, 5, false).setName("3-9");

            // Don't set names
            GHUtility.createEdge(g, mixedCarAccessEnc, 7, 10, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 10, 11, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 11, 12, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 12, 13, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 12, 14, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 13, 15, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 13, 16, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 16, 17, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 17, 18, 5, true);
            GHUtility.createEdge(g, mixedCarAccessEnc, 17, 19, 5, true);
