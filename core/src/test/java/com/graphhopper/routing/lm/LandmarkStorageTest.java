...
public class LandmarkStorageTest {
    ...
    public void testSetGetWeight() {
        GHUtility.createEdge(ghStorage, accessEnc, 0, 1, 40, true);
        Directory dir = new RAMDirectory();
    ...
    public void testWithSubnetworks() {
        GHUtility.createEdge(ghStorage, accessEnc, 0, 1, 10, true);
        GHUtility.createEdge(ghStorage, accessEnc, 1, 2, 10, true);
        ghStorage.edge(2, 4);
        GHUtility.createEdge(ghStorage, accessEnc, 4, 5, 10, true);
        GHUtility.createEdge(ghStorage, accessEnc, 5, 6, 10, false);
    ...
    public void testWithSubnetworks2() {
        ...
        GHUtility.createEdge(ghStorage, accessEnc, 0, 1, 10, true);
        GHUtility.createEdge(ghStorage, accessEnc, 1, 2, 10, true);
        GHUtility.createEdge(ghStorage, accessEnc, 2, 3, 10, false);
        GHUtility.createEdge(ghStorage, accessEnc, 3, 2, 10, false);
        GHUtility.createEdge(ghStorage, accessEnc, 3, 4, 10, true);
    ...
    public void testWithOnewaySubnetworks() {
        ...
        GHUtility.createEdge(ghStorage, accessEnc, 0, 1, 10, true);
        GHUtility.createEdge(ghStorage, accessEnc, 1, 2, 10, false);
        GHUtility.createEdge(ghStorage, accessEnc, 2, 3, 10, false);

        GHUtility.createEdge(ghStorage, accessEnc, 4, 5, 10, true);
        GHUtility.createEdge(ghStorage, accessEnc, 5, 2, 10, false);
    ...
    public void testWeightingConsistence() {
        ...
        GHUtility.createEdge(ghStorage, accessEnc, 0, 1, 10, true);
        EdgeIteratorState edge = GHUtility.createEdge(ghStorage, accessEnc, 1, 2, 10, true);
        edge.set(averageSpeedEnc, 0.9);
        GHUtility.createEdge(ghStorage, accessEnc, 2, 3, 10, true);
    ...
    public void testWithBorderBlocking() {
        AbstractRoutingAlgorithmTester.initBiGraph(ghStorage, accessEnc);
