...
public class CarFlagEncoderTest {
    ...
    private final BooleanEncodedValue accessEnc = em.getBooleanEncodedValue("car.access");
    private final DecimalEncodedValue averageSpeedEnc = em.getDecimalEncodedValue("car.average_speed");
    private final BooleanEncodedValue roundaboutEnc = em.getBooleanEncodedValue("roundabout");
    ...
    public void testRoundabout() {
        ...
        accessEnc.setBool(false, ints, true);
        accessEnc.setBool(true, ints, true);
        roundaboutEnc.setBool(false, ints, true);
    ...
    public void testMaxValue() {
        ...
        // => 96.56 * 0.9 => 86.9
        assertEquals(86.9, instance.getSpeed(ints), 1e-1);
        assertEquals(86.9, instance.getReverseSpeed(ints), 1e-1);
    ...
    public void testRegisterOnlyOnceAllowed() {
        CarFlagEncoder instance = new CarFlagEncoder(10, 0.5, 0);
        new EncodingManager.Builder().addAll(instance).build();
        try {
            new EncodingManager.Builder().addAll(instance).build();
            assertTrue(false);
