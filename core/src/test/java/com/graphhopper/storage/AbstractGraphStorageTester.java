...
public abstract class AbstractGraphStorageTester {
    ...
    protected EncodingManager encodingManager = new EncodingManager.Builder().addAllFlagEncoders("car,foot").build();
    ...
    public void testSetNodes() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, defaultSize + 1, defaultSize + 2, 10d, true);
        GHUtility.createEdge(graph, carAccessEnc, defaultSize + 1, defaultSize + 3, 10, true);
    ...
    public void testCreateLocation() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, carAccessEnc, 1, 50, true);
        assertEquals(1, count(carOutExplorer.setBaseNode(1)));

        GHUtility.createEdge(graph, carAccessEnc, 1, 2, 100, true);
    ...
    public void testEdges() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, carAccessEnc, 2, 1, 12, true);
        assertEquals(1, count(carOutExplorer.setBaseNode(2)));

        GHUtility.createEdge(graph, carAccessEnc, 2, 3, 12, true);
        assertEquals(1, count(carOutExplorer.setBaseNode(1)));
    ...
    public void testUnidirectional() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 1, 2, 12, false);
        GHUtility.createEdge(graph, carAccessEnc, 1, 11, 12, false);
        GHUtility.createEdge(graph, carAccessEnc, 11, 1, 12, false);
        GHUtility.createEdge(graph, carAccessEnc, 1, 12, 12, false);
        GHUtility.createEdge(graph, carAccessEnc, 3, 2, 112, false);
    ...
    public void testUpdateUnidirectional() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 2, 3, 112, false);
    ...
    public void testClone() {
        ...
        na.setNode(2, 2, 10);
        na.setNode(3, 5, 9);
        GHUtility.createEdge(graph, carAccessEnc, 1, 3, 10, true);
        ...
        GHUtility.createEdge(graph, carAccessEnc, 1, 4, 10, true);
    ...
    public void testCopyProperties() {
        graph = createGHStorage();
        EdgeIteratorState edge = GHUtility.createEdge(graph, carAccessEnc, 1, 3, 10, false).setName("testing").setWayGeometry(Helper.createPointList(1, 2));

        EdgeIteratorState newEdge = GHUtility.createEdge(graph, carAccessEnc, 1, 3, 10, false);
    ...
    public void testGetLocations() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 0, 1, 10, true);
        assertEquals(2, graph.getNodes());

        GHUtility.createEdge(graph, carAccessEnc, 0, 2, 10, true);
    ...
    protected void initExampleGraph(Graph g) {
        ...
        na.setNode(4, 2, 1);
        na.setNode(5, 7, 5);
        GHUtility.createEdge(graph, carAccessEnc, 0, 1, 12, true);
        GHUtility.createEdge(graph, carAccessEnc, 0, 2, 212, true);
        GHUtility.createEdge(graph, carAccessEnc, 0, 3, 212, true);
        GHUtility.createEdge(graph, carAccessEnc, 0, 4, 212, true);
        GHUtility.createEdge(graph, carAccessEnc, 0, 5, 212, true);
    }
    ...
    public void testDirectional() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, carAccessEnc, 1, 2, 12, true);
        GHUtility.createEdge(graph, carAccessEnc, 2, 3, 12, false);
        GHUtility.createEdge(graph, carAccessEnc, 3, 4, 12, false);
        GHUtility.createEdge(graph, carAccessEnc, 3, 5, 12, true);
        GHUtility.createEdge(graph, carAccessEnc, 6, 3, 12, false);
    ...
    public void testDozendEdges() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 1, 3, 13, false);
        assertEquals(2, count(carAllExplorer.setBaseNode(1)));

        GHUtility.createEdge(graph, carAccessEnc, 1, 4, 14, false);
        assertEquals(3, count(carAllExplorer.setBaseNode(1)));

        GHUtility.createEdge(graph, carAccessEnc, 1, 5, 15, false);
        assertEquals(4, count(carAllExplorer.setBaseNode(1)));

        GHUtility.createEdge(graph, carAccessEnc, 1, 6, 16, false);
        assertEquals(5, count(carAllExplorer.setBaseNode(1)));

        GHUtility.createEdge(graph, carAccessEnc, 1, 7, 16, false);
        assertEquals(6, count(carAllExplorer.setBaseNode(1)));

        GHUtility.createEdge(graph, carAccessEnc, 1, 8, 16, false);
        assertEquals(7, count(carAllExplorer.setBaseNode(1)));

        GHUtility.createEdge(graph, carAccessEnc, 1, 9, 16, false);
    ...
    public void testDeleteNodeForUnidir() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 10, 20, 10, false);
        GHUtility.createEdge(graph, carAccessEnc, 21, 6, 10, false);
    ...
    public void testDeleteNodes(int fillToSize) {
        ...
        for (int i = 6; i < fillToSize; i++) {
            ...
            if (i % 3 == 0) {
                ...
                // connect to
                // ... a deleted node
                GHUtility.createEdge(graph, carAccessEnc, i, 0, 10 * i, true);
                // ... a non-deleted and non-moved node
                GHUtility.createEdge(graph, carAccessEnc, i, 2, 10 * i, true);
                // ... a moved node
                GHUtility.createEdge(graph, carAccessEnc, i, fillToSize - 1, 10 * i, true);
            }
        }

        GHUtility.createEdge(graph, carAccessEnc, 0, 1, 10, true);
        GHUtility.createEdge(graph, carAccessEnc, 0, 3, 20, false);
        GHUtility.createEdge(graph, carAccessEnc, 3, 5, 20, true);
        GHUtility.createEdge(graph, carAccessEnc, 1, 5, 20, false);
    ...
    public void testSimpleDelete() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 3, 0, 21, true);
        GHUtility.createEdge(graph, carAccessEnc, 5, 0, 22, true);
        GHUtility.createEdge(graph, carAccessEnc, 5, 3, 23, true);
    ...
    public void testSimpleDelete2() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 5, 10, 510, true);
        ...
        GHUtility.createEdge(graph, carAccessEnc, 9, 11, 911, true).setWayGeometry(pl);
        GHUtility.createEdge(graph, carAccessEnc, 9, 12, 912, true).setWayGeometry(pl);
    ...
    public void testSimpleDelete3() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 9, 11, 911, true);
        GHUtility.createEdge(graph, carAccessEnc, 7, 9, 78, true);
        GHUtility.createEdge(graph, carAccessEnc, 8, 9, 89, true);
    ...
    public void testFlags() {
        graph = createGHStorage();
        EdgeIteratorState edge = GHUtility.createEdge(graph, carAccessEnc, 0, 1, 10d, true);
        edge.set(carAverageSpeedEnc, 100d);
        edge = GHUtility.createEdge(graph, carAccessEnc, 2, 3, 10d, false);
        ...
        try {
            GHUtility.createEdge(graph, carAccessEnc, 0, 1, -1d, true);
            assertTrue(false);
    ...
    public void testEdgeProperties() {
        graph = createGHStorage();
        EdgeIteratorState iter1 = GHUtility.createEdge(graph, carAccessEnc, 0, 1, 10, true);
        EdgeIteratorState iter2 = GHUtility.createEdge(graph, carAccessEnc, 0, 2, 20, true);
    ...
    public void testCreateDuplicateEdges() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 2, 1, 12, true);
        GHUtility.createEdge(graph, carAccessEnc, 2, 3, 12, true);
        GHUtility.createEdge(graph, carAccessEnc, 2, 3, 13, false);
        ...
        GHUtility.createEdge(graph, carAccessEnc, 3, 2, 14, true);
    ...
    public void testIdenticalNodes() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, carAccessEnc, 0, 0, 100, true);
    ...
    public void testIdenticalNodes2() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, carAccessEnc, 0, 0, 100, false);
        GHUtility.createEdge(graph, carAccessEnc, 0, 0, 100, false);
    ...
    public void testEdgeReturn() {
        graph = createGHStorage();
        EdgeIteratorState iter = GHUtility.createEdge(graph, carAccessEnc, 4, 10, 100d, false);
        iter.set(carAverageSpeedEnc, 10d);
        assertEquals(4, iter.getBaseNode());
        assertEquals(10, iter.getAdjNode());
        iter = GHUtility.createEdge(graph, carAccessEnc, 14, 10, 100d, false);
        iter.set(carAverageSpeedEnc, 10d);
    ...
    public void testPillarNodes() {
        ...
        EdgeIteratorState edge = GHUtility.createEdge(graph, carAccessEnc, 0, 4, 100d, false).setWayGeometry(pointList);
        edge.set(carAverageSpeedEnc, 10d);
        pointList = Helper.createPointList(1, 5, 1, 6, 1, 7, 1, 8, 1, 9);
        edge = GHUtility.createEdge(graph, carAccessEnc, 4, 10, 100d, false).setWayGeometry(pointList);
        edge.set(carAverageSpeedEnc, 10d);
        pointList = Helper.createPointList(1, 13, 1, 12, 1, 11);
        edge = GHUtility.createEdge(graph, carAccessEnc, 14, 0, 100d, false).setWayGeometry(pointList);
        edge.set(carAverageSpeedEnc, 10d);
    ...
    public void testFootMix() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, footAccessEnc, 0, 1, 10d, true).set(footAverageSpeedEnc, 10d);
        GHUtility.createEdge(graph, carAccessEnc, 0, 2, 10d, true).set(carAverageSpeedEnc, 10d);
    ...
    public void testGetAllEdges() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, carAccessEnc, 0, 1, 2, true);
        GHUtility.createEdge(graph, carAccessEnc, 3, 1, 1, false);
        GHUtility.createEdge(graph, carAccessEnc, 3, 2, 1, false);
    ...
    public void testGetAllEdgesWithDelete() {
        ...
        na.setNode(2, 2, 5);
        na.setNode(3, 3, 5);
        GHUtility.createEdge(graph, carAccessEnc, 0, 1, 1, true);
    ...
    public void testNameIndex() {
        ...
        EdgeIteratorState iter2 = GHUtility.createEdge(graph, carAccessEnc, 0, 1, 10, true);
    ...
    public void test8BytesFlags() {
        ...
        list.add(new TmpCarFlagEncoder(29, 0.001, 0));
        EncodingManager manager = new EncodingManager.Builder().addAll(list, 8).build();
    ...
    public void testDontGrowOnUpdate() throws IOException {
        ...
        EdgeIteratorState iter2 = GHUtility.createEdge(graph, carAccessEnc, 0, 1, 100, true);
        ...
        EdgeIteratorState iter1 = GHUtility.createEdge(graph, carAccessEnc, 0, 2, 200, true);
    ...
    public void testDetachEdge() {
        graph = createGHStorage();
        GHUtility.createEdge(graph, carAccessEnc, 0, 1, 2d, true);
        GHUtility.createEdge(graph, carAccessEnc, 0, 2, 2d, false).
                setWayGeometry(Helper.createPointList(1, 2, 3, 4)).
                set(carAverageSpeedEnc, 10d);
        GHUtility.createEdge(graph, carAccessEnc, 1, 2, 2d, true);
        ...
        GHUtility.createEdge(graph, carAccessEnc, 3, 3, 2, false).set(carAverageSpeedEnc, 10d);
