...
public class GraphHopperStorageCHTest extends GraphHopperStorageTest {
    ...
    public void testEdgeFilter() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 0, 2, 20, true);
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 30, true);
    ...
    public void testDisconnectEdge() {
        ...
        GHUtility.createEdge(lg, carAccessEnc, 4, 1, 30, true);
        graph.freeze();
    ...
    public void testGetWeightIfAdvancedEncoder() {
        ...
        EncodingManager em = new EncodingManager.Builder().addAll(customEncoder).build();
    ...
    public void testShortcutCreationAndAccessForManyVehicles() {
        ...
        EncodingManager em = new EncodingManager.Builder().addAll(tmpCar, tmpBike).build();
