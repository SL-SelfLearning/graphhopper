...
public class GraphHopperStorageTest extends AbstractGraphStorageTester {
    ...
    public void testSave_and_fileFormat() throws IOException {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 9, 10, 200, true);
        GHUtility.createEdge(graph, carAccessEnc, 9, 11, 200, true);
        GHUtility.createEdge(graph, carAccessEnc, 1, 2, 120, false);
        ...
        GHUtility.createEdge(graph, carAccessEnc, 3, 4, 123, true).
    ...
    public void internalDisconnect() {
        ...
        EdgeIteratorState iter0 = GHUtility.createEdge(graph, carAccessEnc, 0, 1, 10, true);
        EdgeIteratorState iter2 = GHUtility.createEdge(graph, carAccessEnc, 1, 2, 10, true);
        EdgeIteratorState iter3 = GHUtility.createEdge(graph, carAccessEnc, 0, 3, 10, true);
    ...
    public void testEnsureSize() {
        ...
        GHUtility.createEdge(graph, carAccessEnc, 0, testIndex, 10, true);
    ...
    public void testAdditionalEdgeField() {
        ...
        storage.create(1000);
        EdgeIteratorState iter = GHUtility.createEdge(storage, carAccessEnc, 0, 1, 10, true);
