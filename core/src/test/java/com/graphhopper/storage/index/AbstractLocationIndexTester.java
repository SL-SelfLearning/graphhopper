...
public abstract class AbstractLocationIndexTester {
    ...
    public void testSimpleGraph() {
        GraphHopperStorage g = createGHStorage(new EncodingManager.Builder().addAllFlagEncoders("car").build());
    ...
    public void initSimpleGraph(Graph g, List<BooleanEncodedValue> accessEncList) {
        //  6 |       4
        //  5 |           
        //    |     6
        //  4 |              5
        ...
        for (BooleanEncodedValue accessEnc : accessEncList) {
            GHUtility.createEdge(g, accessEnc, 0, 1, 3.5, true);
            GHUtility.createEdge(g, accessEnc, 0, 2, 2.5, true);
            GHUtility.createEdge(g, accessEnc, 2, 3, 1, true);
            GHUtility.createEdge(g, accessEnc, 3, 4, 3.2, true);
            GHUtility.createEdge(g, accessEnc, 1, 4, 2.4, true);
            GHUtility.createEdge(g, accessEnc, 3, 5, 1.5, true);
            // make sure 6 is connected
            GHUtility.createEdge(g, accessEnc, 6, 4, 1.2, true);
        }
    }
    ...
    public void testGrid() {
        ...
        initSampleGraph(g, em.getBooleanEncodedValue(TagParserFactory.Car.ACCESS));
        int locs = g.getNodes();
    ...
    public Graph initSampleGraph(Graph graph, BooleanEncodedValue accessEnc) {
...
//   lon: 0   1   2   3   4   5
        ...
        GHUtility.createEdge(graph, accessEnc, a0, b1, 1, true);
        GHUtility.createEdge(graph, accessEnc, c2, b1, 1, true);
        GHUtility.createEdge(graph, accessEnc, c2, d3, 1, true);
        GHUtility.createEdge(graph, accessEnc, f5, b1, 1, true);
        GHUtility.createEdge(graph, accessEnc, e4, f5, 1, true);
        GHUtility.createEdge(graph, accessEnc, m12, d3, 1, true);
        GHUtility.createEdge(graph, accessEnc, e4, k10, 1, true);
        GHUtility.createEdge(graph, accessEnc, f5, d3, 1, true);
        GHUtility.createEdge(graph, accessEnc, f5, i8, 1, true);
        GHUtility.createEdge(graph, accessEnc, f5, j9, 1, true);
        GHUtility.createEdge(graph, accessEnc, k10, g6, 1, true);
        GHUtility.createEdge(graph, accessEnc, j9, l11, 1, true);
        GHUtility.createEdge(graph, accessEnc, i8, l11, 1, true);
        GHUtility.createEdge(graph, accessEnc, i8, h7, 1, true);
        GHUtility.createEdge(graph, accessEnc, k10, n13, 1, true);
        GHUtility.createEdge(graph, accessEnc, k10, o14, 1, true);
        GHUtility.createEdge(graph, accessEnc, l11, p15, 1, true);
        GHUtility.createEdge(graph, accessEnc, m12, p15, 1, true);
        GHUtility.createEdge(graph, accessEnc, q16, p15, 1, true);
        GHUtility.createEdge(graph, accessEnc, q16, m12, 1, true);
        return graph;
    }
    ...
    public void testDifferentVehicles() {
        ...
        initSimpleGraph(g, Arrays.asList(carAccessEnc, footAccessEnc));
        idx = createIndex(g, -1);
