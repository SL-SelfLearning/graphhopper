...
public class LocationIndexTreeCHTest extends LocationIndexTreeTest {
    ...
    public void testCHGraph() {
        ...
        EdgeIteratorState iter1 = GHUtility.createEdge(ghStorage, carAccessEnc, 0, 1, 10, true);
        EdgeIteratorState iter2 = GHUtility.createEdge(ghStorage, carAccessEnc, 1, 2, 10, true);
        EdgeIteratorState iter3 = GHUtility.createEdge(ghStorage, carAccessEnc, 2, 3, 14, true);
        EdgeIteratorState iter4 = GHUtility.createEdge(ghStorage, carAccessEnc, 3, 4, 14, true);
    ...
    public void testCHGraphBug() {
        ...
        na.setNode(3, 0.5, 1);
        EdgeIteratorState iter1 = GHUtility.createEdge(g, carAccessEnc, 1, 0, 100, true);
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 100, true);
