...
public class InstructionListTest {
    ...
    public void testWayList() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 0, 1, 10000, true).setName("0-1");
        GHUtility.createEdge(g, carAccessEnc, 1, 2, 11000, true).setName("1-2");

        GHUtility.createEdge(g, carAccessEnc, 0, 3, 11000, true);
        GHUtility.createEdge(g, carAccessEnc, 1, 4, 10000, true).setName("1-4");
        GHUtility.createEdge(g, carAccessEnc, 2, 5, 11000, true).setName("5-2");

        GHUtility.createEdge(g, carAccessEnc, 3, 6, 11000, true).setName("3-6");
        GHUtility.createEdge(g, carAccessEnc, 4, 7, 10000, true).setName("4-7");
        GHUtility.createEdge(g, carAccessEnc, 5, 8, 10000, true).setName("5-8");

        GHUtility.createEdge(g, carAccessEnc, 6, 7, 11000, true).setName("6-7");
        EdgeIteratorState iter = GHUtility.createEdge(g, carAccessEnc, 7, 8, 10000, true);
        ...
        iter.setName("7-8");
        // missing edge name
        GHUtility.createEdge(g, carAccessEnc, 9, 10, 10000, true);
        EdgeIteratorState iter2 = GHUtility.createEdge(g, carAccessEnc, 8, 9, 20000, true);
        list.clear();
        list.add(1.0, 1.3);
        iter2.setName("8-9");
    ...
    public void testWayList2() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 3, 4, 100, true).setName("3-4");
        GHUtility.createEdge(g, carAccessEnc, 4, 5, 100, true).setName("4-5");

        EdgeIteratorState iter = GHUtility.createEdge(g, carAccessEnc, 2, 4, 100, true);
        iter.setName("2-4");
        PointList list = new PointList();
    ...
    public void testNoInstructionIfSameStreet() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 3, 4, 100, true).setName("street");
        GHUtility.createEdge(g, carAccessEnc, 4, 5, 100, true).setName("4-5");
    ...
    public void testInstructionsWithTimeAndPlace() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 2, 7000, true).setName("1-2").set(carAverageSpeedEnc, 70d);
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 8000, true).setName("2-3").set(carAverageSpeedEnc, 80d);
        GHUtility.createEdge(g, carAccessEnc, 2, 6, 10000, true).setName("2-6").set(carAverageSpeedEnc, 10d);
        GHUtility.createEdge(g, carAccessEnc, 3, 4, 9000, true).setName("3-4").set(carAverageSpeedEnc,  90d);
        GHUtility.createEdge(g, carAccessEnc, 3, 7, 10000, true).setName("3-7").set(carAverageSpeedEnc, 10d);
        GHUtility.createEdge(g, carAccessEnc, 4, 5, 10000, true).setName("4-5").set(carAverageSpeedEnc, 100d);
    ...
    public void testFind() {
        ...
        GHUtility.createEdge(g, carAccessEnc, 1, 2, 10000, true).setName("1-2");
        GHUtility.createEdge(g, carAccessEnc, 2, 3, 10000, true).setName("2-3");
        GHUtility.createEdge(g, carAccessEnc, 2, 6, 10000, true).setName("2-6");
        GHUtility.createEdge(g, carAccessEnc, 3, 4, 10000, true).setName("3-4").setWayGeometry(waypoint);
        GHUtility.createEdge(g, carAccessEnc, 3, 7, 10000, true).setName("3-7");
        GHUtility.createEdge(g, carAccessEnc, 4, 5, 10000, true).setName("4-5");
